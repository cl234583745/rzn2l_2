...
#define CONFIG_USBDEV_DEBUG_LEVEL       0       /* 调试级别: 0=无, 1=错误, 2=警告, 3=信息 */
#define CONFIG_USB_DBG_LEVEL            0       /* 日志级别: 0=无, 1=错误, 2=警告, 3=信息 */
#define CONFIG_USB_PRINTF(...)          ((void)0)  /* 禁用USB日志输出 */
