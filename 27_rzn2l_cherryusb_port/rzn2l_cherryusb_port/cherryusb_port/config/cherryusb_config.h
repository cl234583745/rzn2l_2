...
//#define CONFIG_USB_HS                   1       /* 声明是高速，不声明是全速 */
...
#ifdef CONFIG_USB_HS
#define CDC_ACM_EP_IN_MAX_PACKET        512     /* IN最大包长(HS) */
#define CDC_ACM_EP_OUT_MAX_PACKET       512     /* OUT最大包长(HS) */
#else
#define CDC_ACM_EP_IN_MAX_PACKET        64      /* IN最大包长(FS) */
#define CDC_ACM_EP_OUT_MAX_PACKET       64      /* OUT最大包长(FS) */
#endif
...
/* ========== 缓冲区配置 ========== */
#ifdef CONFIG_USB_HS
#define CDC_ACM_RX_BUFFER_SIZE          16384   /* HS: larger buffer for throughput */
#define CDC_ACM_TX_BUFFER_SIZE          16384
#else
#define CDC_ACM_RX_BUFFER_SIZE          2048    /* FS: 2048 */
