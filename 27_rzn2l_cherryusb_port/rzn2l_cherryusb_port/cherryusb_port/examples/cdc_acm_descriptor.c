...
/* ========== Device Qualifier Descriptor (HS required) ========== */
#ifdef CONFIG_USB_HS
static const uint8_t cdc_acm_device_qualifier_descriptor[] = {
    0x0A,                            /* bLength */
...
#ifdef CONFIG_USB_HS
static const uint8_t *cdc_acm_device_qualifier_descriptor_callback(uint8_t speed)
{
    (void)speed;
#ifdef CONFIG_USB_HS
    return cdc_acm_device_qualifier_descriptor;
#else
    return NULL;
#endif
}
...
#ifdef CONFIG_USB_HS
    .device_quality_descriptor_callback = cdc_acm_device_qualifier_descriptor_callback,
#else
