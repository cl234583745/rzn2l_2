...
#define VECTOR_NUMBER_GPT8_OVF ((IRQn_Type) 194) /* GPT8_OVF (GPT8 GTCNT overflow (GTPR compare match)) */
typedef enum IRQn
{
    ...
    GPT8_OVF_IRQn = 194, /* GPT8_OVF (GPT8 GTCNT overflow (GTPR compare match)) */
