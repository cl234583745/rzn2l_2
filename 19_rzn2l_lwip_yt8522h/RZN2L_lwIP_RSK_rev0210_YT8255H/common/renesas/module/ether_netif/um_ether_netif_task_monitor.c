...
static void _task_code (void * pvParameter)
{
    ...
    while(true)
    {
        ...
        /** Decide link event */
        callback_event = ( USR_SUCCESS == usr_err ) ? ETHER_NETIF_CALLBACK_EVENT_LINK_UP : ETHER_NETIF_CALLBACK_EVENT_LINK_DOWN;
        ...
        if( callback_event != callback_event_prev )
        {
            ...
            usr_err = um_ether_netif_callback_request((ether_netif_callback_ctrl_t * ) p_ctrl->p_callback_ctrl, callback_event, NULL );
        }
